 ...
 *
 * <p>根bean定义也可以用于在配置阶段注册单个bean定义。但是，自从spring2.5以来
 * ，通过编程注册bean定义的首选方法是{@link GenericBeanDefinition}类。
 * GenericBeanDefinition的优点是，它允许动态定义父依赖项，而不是将角色“硬编码”为根bean定义。
 *
 * @author Rod Johnson
