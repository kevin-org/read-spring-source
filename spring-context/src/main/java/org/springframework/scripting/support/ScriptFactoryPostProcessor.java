...
/**
 * {@link BeanPostProcessor}处理{@link org.springframework.scripting}。定义，用工厂生成的实际脚本化Java对象替换每个工厂。
 *
...
public class ScriptFactoryPostProcessor extends InstantiationAwareBeanPostProcessorAdapter implements
	...
	/**
	 * 在这个后处理程序使用的内部BeanFactory中准备脚本bean。
	 * 每个原始bean定义将被拆分为ScriptFactory定义和脚本对象定义。
	 *
